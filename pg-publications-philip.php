  ...
  <div class="wrap">
    <main>
      ...
      <header class="page-header region">
        <h1 class="page-title"><?php echo _e("Publications by Philip Yenawine","focustheme");?></h1>
      </header>
      ...
      <?php else:?>
        <div class="region">
          <p><?php nothing_found("Sorry, we couldn't find any publications by Philip Yenawine");?></p>
        </div>
      <?php endif;?>
