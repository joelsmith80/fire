...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	...
	<h2 class="tribe-events-single-section-title"> <?php esc_html_e( 'Event Basics', 'the-events-calendar' ) ?> </h2>
	...
	<dl>
		...
		<?php if(get_field('vts_event_facilitator')){
			...
			<dt> <?php esc_html_e( 'Facilitator(s):', 'the-events-calendar' ) ?> </dt>
			<dd class="tribe-events-facilitator"><?php echo implode(', ',$facilitators);?></dd>
		<?php }?>

		<!-- Optional sample agenda -->
		<?php if(get_field('vts_event_agenda')):?>
		<dt> <?php esc_html_e( 'Sample agenda:', 'the-events-calendar' ) ?> </dt>
		<dd class="tribe-events-agenda"><a href="<?php echo get_field('vts_event_agenda');?>">Download</a></dd>
		<?php endif;?>
